...
var queue = housecall({ concurrency: 2, cooldown: 1000 });
 ...
 class Header extends Component {
  ...
  fetchdemandesApprentissages(){
    queue.push(() => axios.get('/api/back/liste_des_demandes_pour_apprentissage').then((response) => {
      
        const action = {type: "GET_DEMANDE_VEHICULE", value: response.data}
        this.props.dispatch(action)
    }));
  }

  fetchUsers(){
    queue.push(() => axios.get('/api/back/users').then((response) => {
      
        const action = {type: "GET_USER", value: response.data}
        this.props.dispatch(action)
    }));
  }

  componentDidMount(){
    this.fetchdemandesApprentissages()
    this.fetchUsers()
  ...
  render() {
    return (
      ...
      <a href="index2.html" className="logo">
        <span className="logo-mini"><b>M</b>LIDE</span>
        <span className="logo-lg"><b>MonBolide</b>.COM</span>
      </a>
        ...
        <div className="navbar-custom-menu">
          <ul className="nav navbar-nav">
                ...
                <li>
                  <ul className="menu">
                    <li>
                      <a href="#">
                        <div className="pull-left">
                          <img src="/back/dist/img/user2-160x160.jpg" className="img-circle" alt="User Image" />
                        </div>
                        <h4>
                          Support Team
                    ...
                    <li>
                      <a href="#">
                        <div className="pull-left">
                          <img src="/back/dist/img/user3-128x128.jpg" className="img-circle" alt="User Image" />
                        </div>
                        <h4>
                    ...
                    <li>
                      <a href="#">
                        <div className="pull-left">
                          <img src="/back/dist/img/user4-128x128.jpg" className="img-circle" alt="User Image" />
                        </div>
                        <h4>
                          Developers
            ...
            <li className="dropdown user user-menu">
              <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                <img src="/back/dist/img/user2-160x160.jpg" className="user-image" alt="User Image" />
