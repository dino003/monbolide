    ...
    return (
      ...
      <section className="sidebar">
        ...
        <ul className="sidebar-menu" data-widget="tree">
          ...
          <li><a href="/">
            <i className="fa fa-circle-o"></i> Acceuil Front</a></li>

          <li className="active">
          <NavLink exact activeClassName="active"  to="/v1/admin_area/dashboard">
          ...
          <li>
            <NavLink exact activeClassName="active"  to="/v1/admin_area/gestion-des-demandes">
              <i className="fa fa-th"></i> <span>Gestion des demandes</span>
              <span className="pull-right-container">
          ...
          <li>
          <NavLink exact activeClassName="active"  to="/v1/admin_area/gestion-des-utilisateurs">
